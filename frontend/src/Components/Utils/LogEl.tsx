...
export default function LogEl(props:TweetProps) {
    ...
    return <div className="tweet" id={id}>
        ...
        <div className="tweet-body">
            ...
            <div className="hashtag" onClick={() => navigate(`/explore/${hashtag}`)}>{hashtag}</div>
        </div>
        <div className="like">
            <div className='heart' onClick={logLiked} id={id}>
                { liked ? <FontAwesomeIcon className='liked' icon={faHeart} /> : <RegularHeart /> }
            </div>
